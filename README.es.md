...
| Comandos | Proxy |
| --- | --- |
| ![Comandos](docs/images/commands.jpg) | ![Proxy](docs/images/proxy.jpg) |
...
| `hideck_v2.1.15_linux_arm64` | ARM64 / Raspberry Pi OS 64-bit, glibc + UPX |
| `hideck_v2.1.15_linux_armv7` | ARM 32-bit, glibc + UPX |
| `hideck_v2.1.15_openwrt_amd64` | OpenWrt x86_64, musl estático, sin UPX |
