...
test('navy-light tokens match the approved palette', () => {
  ...
  assert.match(globalStyles, /:root \{[\s\S]*--ui-radius-sm: 12px;/)
  assert.match(globalStyles, /:root \{[\s\S]*--ui-radius-md: 16px;/)
  assert.match(globalStyles, /:root \{[\s\S]*--ui-radius-lg: 20px;/)
