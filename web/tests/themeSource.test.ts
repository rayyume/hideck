...
test('navy-light tokens match the approved palette', () => {
  ...
  assert.match(globalStyles, /:root \{[\s\S]*--ui-shadow-sm: 0 8px 22px rgba\(11, 53, 88, 0.06\);/)
  assert.match(globalStyles, /:root \{[\s\S]*--ui-shadow-md: 0 14px 32px rgba\(11, 53, 88, 0.08\);/)
