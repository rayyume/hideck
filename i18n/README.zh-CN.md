...
| `hideck_v2.1.19_linux_arm64` | ARM64 / 树莓派 OS 64 位，glibc + UPX |
| `hideck_v2.1.19_linux_armv7` | 32 位 ARM，glibc + UPX |
| `hideck_v2.1.19_openwrt_amd64` | OpenWrt x86_64，musl 静态，不压 UPX |
| `hideck_v2.1.19_openwrt_arm64` | OpenWrt aarch64 |
| `hideck_v2.1.19_openwrt_armv7` | OpenWrt 32 位 ARM |
