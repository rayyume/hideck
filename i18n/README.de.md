...
| `hideck_v2.1.17_linux_arm64` | ARM64 / Raspberry Pi OS 64-Bit, glibc + UPX |
| `hideck_v2.1.17_linux_armv7` | 32-Bit-ARM, glibc + UPX |
| `hideck_v2.1.17_openwrt_amd64` | OpenWrt x86_64, musl statisch, ohne UPX |
| `hideck_v2.1.17_openwrt_arm64` | OpenWrt aarch64 |
| `hideck_v2.1.17_openwrt_armv7` | OpenWrt 32-Bit-ARM |
