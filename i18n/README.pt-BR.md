...
| `hideck_v2.1.21_linux_armv7` | ARM 32-bit, glibc + UPX |
| `hideck_v2.1.21_openwrt_amd64` | OpenWrt x86_64, musl estático, sem UPX |
| `hideck_v2.1.21_openwrt_arm64` | OpenWrt aarch64 |
| `hideck_v2.1.21_openwrt_armv7` | OpenWrt ARM 32-bit |
