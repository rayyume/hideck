...
| `hideck_v2.1.20_linux_armv7` | ARM 32-bit, glibc + UPX |
| `hideck_v2.1.20_openwrt_amd64` | OpenWrt x86_64, musl estático, sin UPX |
| `hideck_v2.1.20_openwrt_arm64` | OpenWrt aarch64 |
| `hideck_v2.1.20_openwrt_armv7` | OpenWrt ARM 32-bit |
